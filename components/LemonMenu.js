...
const Item = ({UsersData}) =>{
    return(
        <View style={scrollStyle.box} >
            <Text>{UsersData.name}</Text>
            <Text>{UsersData.email}</Text>
            ...
            {/* <ScrollView style={scrollStyle.scrollContainer} horizontal={true}>
                {
                    menuList.map((item,index) => {
                        return(
                            <Text key={index} style={[scrollStyle.box,scrollStyle.shadowProp]}>{item}</Text>
                        )
                    })
                }
            </ScrollView> */}
